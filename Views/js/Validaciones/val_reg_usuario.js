function Val_reg_usuarios() {
    ...
    if (id == null || id.length == 0 || /^\s+$/.test(id)) {
        ...
        xhttp.open("POST", "../dashboard/Views/Container/Crud/Usuarios/v_r_usuario.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhttp.send("documento=" + id + "&nombre=" + nom + "&apellido=" + apell + "&telefono_f=" + tel_f + "&pass=" + contra + "&email=" + email + "&telefono_m=" + tel_m + "&direccion=" + direc + "&estado=" + esta + "&t_doc=" + tipo_doc + "&rol=" + rol);
